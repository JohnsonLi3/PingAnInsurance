...
<form name="searchform" action="insertemailtype" method="post">
...
<table class="table_form">
	<tr>
		...
		<td><input type="text" name="emailtypename"/></td>
	</tr>
	<tr>
		<td class="td_title" align="left" width="10%">模板内容</td>
		<td>
			<input type="text" name="emailtypecon"/>
		</td>
	</tr>
	<tr>
		<td class="td_title" align="left" width="10%">模板说明</td>
		<td colspan="3">
			<input type="text" name="emailtypedesc"/>
		</td>
	</tr>
</table>
</div>
