...
<table class="table_form">
	<tr>
		...
		<td colspan="3"><input type="text" value="${anno.infortitle}" /></td>
	</tr>
	<tr>
		<td class="td_title">消息内容</td>
		<td colspan="3"><input type="text" value="${anno.information}" ></td>
	</tr>
	<tr>
		<td class="td_title">消息备注</td>
		<td colspan="3"><input type="text" value="${anno.inforcomment}" ></td>
	</tr>
	<tr>
		<td class="td_title">启用日期</td>
		<td><input type="text" value="${anno.starttime}" /></td>
		<td class="td_title">过期日期</td>
		<td><input type="text" value="${anno.pastdue}" /></td>
	</tr>
</table>
</div>
