...
<div>
<div class="title2 margin">基础信息：</div>
<table class="table_form">
	<tr>
		<td class="td_title">分类编码</td>
		<td>${bd.categoryid}</td>
...
<table class="table_list">
	...
	<thead>
		...
		<c:forEach  items="${di}" var="detailinfor" varStatus="dicount">
	<tbody id="tabValue">
		<tr>
			<td>${detailinfor.sbid}</td>
			...
			<td><a href="detailBaseData.jsp"><input type="button" id="addId" value="新  增" class="button btn_xs" /></a>
			        </td>
		</tr>
		</c:forEach>
	</tbody>
